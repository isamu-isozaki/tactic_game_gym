...
def game_args_parser():
	...
	parser.add_argument('--archer_hp', type=float, default=0.4, help='How much more hp archer has than the infantry. This is to account for their larger size.')
	parser.add_argument('--archer_k', type=float, default=1, help='The multiplier to the spring coefficient for archer')
	parser.add_argument('--archer_max_speed', type=float, default=0.8, help='How much more larger the max speed of the archer is')
	parser.add_argument('--archer_prop', type=float, default=0, help='The proportion of archer in troops.')
	...
	parser.add_argument('--base_vision', type=float, default=3, help='Mean of base vision.')#This is the same as attack range
	...
	parser.add_argument('--board_size', type=int, default=200, help='The number of sides in the war. Due to diamond square algorithm, must be in the form of 2^n+1')
	...
	parser.add_argument('--cavarly_max_speed', type=float, default=1, help='How much more larger the max speed of the cavarly is')
	parser.add_argument('--cavarly_prop', type=float, default=0, help='The proportion of cavarly in troops.')
	parser.add_argument('--cavarly_scale', type=float, default=1., help='How much larger the radius of the cavarly is than the infantry')
	...
	parser.add_argument('--r_damage_reward_frac', type=float, default=0.1, help='The coefficient to hard coded reward of r_damage')
	...
	parser.add_argument('--dense_rewards', default=False, action='store_true', help='Whether agent has dense rewards or not')
	...
	parser.add_argument('--game_size', type=int, default=512, help='The game window size')
	...
	parser.add_argument('--infantry_base_vision', type=float, default=6., help='The attack range of infantry.')
	parser.add_argument('--infantry_density', type=float, default=1., help='The mass density of infantry.')
	parser.add_argument('--infantry_force', type=float, default=0.5, help='The force coefficient of infantry')
	...
	parser.add_argument('--infantry_prop', type=float, default=0.45, help='The proportion of cavarly in troops.')
	...
	parser.add_argument('--max_speed', type=float, default=4.0, help='The max speed')
	parser.add_argument('--min_frac', default=1/4., type=float, help='The proportion of players at which the game ends')
	parser.add_argument('--min_players', default=0, type=int, help='The minimum number of players at which point the game ends')
	parser.add_argument('--moves_without_attack', type=int, default=3, help='The number of moves without needing to attack')
	parser.add_argument('--moves_without_model', default=8, type=int, help='The number of moves until getting the next the step from model')
	...
	parser.add_argument('--num_types', type=int, default=1, help='The number of player types')
	parser.add_argument('--obs_board_size', type=int,default=65, help='The board size for observation board')
	parser.add_argument('--passive_range', type=float,default=2, help='The minimum attack range a player can have')
	...
	parser.add_argument('--prop_side', type=float, default=0.2, help='The proportion of attack that goes behind')
	...
	parser.add_argument('--r_seen_reward_frac', type=int, default=0, help='The coefficient to hard coded reward for seeing')
	...
	parser.add_argument('--strength', type=float, default=0.25, help='Mean strength of player')
	...
	parser.add_argument('--wall_prop', type=float, default=0., help='The proportion of walls in troops.')
