...
def game_args_parser():
	...
	parser.add_argument('--archer_prop', type=float, default=0.35, help='The proportion of archer in troops.')
	...
	parser.add_argument('--cavarly_force', type=float, default=0.8, help='How much more force cavarly has than the infantry. This is to account for their larger mass.')
	...
	parser.add_argument('--infantry_base_vision', type=float, default=5., help='The attack range of infantry.')
	...
	parser.add_argument('--infantry_max_speed', type=float, default=0.8, help='How much more larger the max speed of the cavarly is')
