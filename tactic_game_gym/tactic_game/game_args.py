...
def game_args_parser():
	...
	parser.add_argument('--cavarly_force', type=float, default=1*1.2**3, help='How much more force cavarly has than the infantry. This is to account for their larger mass.')
