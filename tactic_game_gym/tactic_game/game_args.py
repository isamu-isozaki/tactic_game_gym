...
def game_args_parser():
	...
	parser.add_argument('--archer_base_vision', type=float, default=17.0, help='The attack range of archer')
	...
	parser.add_argument('--infantry_base_vision', type=float, default=13., help='The attack range of infantry.')
	...
	parser.add_argument('--max_speed', type=float, default=3.0, help='The max speed')
	parser.add_argument('--min_frac', default=1/2., type=float, help='The proportion of players at which the game ends')
	...
	parser.add_argument('--moves_without_model', default=5, type=int, help='The number of moves until getting the next the step from model')
