...
def game_args_parser():
	...
	parser.add_argument('--cavarly_base_vision', type=float, default=15., help='The attack range of cavarly')
	parser.add_argument('--cavarly_density', type=float, default=1, help='The mass density of cavarly')
	parser.add_argument('--cavarly_force', type=float, default=1.5, help='How much more force cavarly has than the infantry. This is to account for their larger mass.')
	...
	parser.add_argument('--infantry_base_vision', type=float, default=15., help='The attack range of infantry.')
