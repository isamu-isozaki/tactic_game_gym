...
def game_args_parser():
	...
	parser.add_argument('--archer_base_vision', type=float, default=30.0, help='The attack range of archer')
	...
	parser.add_argument('--continue_penalty', type=float, default=-0.00, help='The penalty for prolonging the game this is deducted from energy bar')
