...
def game_args_parser():
	...
	parser.add_argument('--cohesion_force_prop', type=float, default=3.0, help='The force that makes the players move in the same direction')
	...
	parser.add_argument('--wall_force', type=float, default=80, help='How much more force cavarly has than the infantry. This is to account for their larger mass.')
