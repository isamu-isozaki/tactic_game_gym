...
def game_args_parser():
	...
	parser.add_argument('--archer_base_vision', type=float, default=15.0, help='The attack range of archer')
	...
	parser.add_argument('--archer_hp', type=float, default=0.5, help='How much more hp cavarly has than the infantry. This is to account for their larger size.')
	parser.add_argument('--archer_k', type=float, default=1, help='The multiplier to the spring coefficient for cavarly')
	parser.add_argument('--archer_max_speed', type=float, default=1, help='How much more larger the max speed of the cavarly is')
	parser.add_argument('--archer_prop', type=float, default=0.3, help='The proportion of cavarly in troops.')
	parser.add_argument('--archer_scale', type=float, default=1, help='How much larger the radius of the cavarly is than the infantry')
	...
	parser.add_argument('--cohesion_force_prop', type=float, default=1.0, help='The force that makes the players move in the same direction')
	...
	parser.add_argument('--damping_start', type=float, default=0.8, help='The proportion of max velocity at which damping starts')
	...
	parser.add_argument('--wall_force', type=float, default=2, help='How much more force cavarly has than the infantry. This is to account for their larger mass.')
	...
	parser.add_argument('--wall_k', type=float, default=10, help='The multiplier to the spring coefficient for cavarly')
