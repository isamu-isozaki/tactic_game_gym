...
def game_args_parser():
	...
	parser.add_argument('--cohesion_force_prop', type=float, default=6.0, help='The force that makes the players move in the same direction')
	...
	parser.add_argument('--player_force', type=float, default=0.5, help='The max magnitude of player force')
	parser.add_argument('--player_force_prop', type=float, default=1.5, help='The coefficient of the player force')
	...
	parser.add_argument('--wall_force', type=float, default=40, help='How much more force cavarly has than the infantry. This is to account for their larger mass.')
