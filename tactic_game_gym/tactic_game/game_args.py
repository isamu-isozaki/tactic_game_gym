...
def game_args_parser():
	...
	parser.add_argument('--g', type=float, default=5.0, help='The gravitational constant')
	parser.add_argument('--max_angle', type=float, default=np.pi/2.0000000001, help='The maximum angle possible for the terrain to have')
	...
	parser.add_argument('--stage_update_num', default=1e5, type=float, help='The number of moves until getting the next the step from model')
	return parser
