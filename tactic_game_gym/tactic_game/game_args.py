...
def game_args_parser():
	...
	parser.add_argument('--spring_force', type=float, default=1.0, help='The coefficient of the spring force')
	parser.add_argument('--spring_force_prop', type=float, default=0.25, help='The coefficient of the spring force')
	parser.add_argument('--g', type=float, default=1, help='The gravitational constant')
