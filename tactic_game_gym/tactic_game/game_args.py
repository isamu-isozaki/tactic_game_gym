...
def game_args_parser():
	...
	parser.add_argument('--archer_base_vision', type=float, default=25.0, help='The attack range of archer')
	...
	parser.add_argument('--cap_prop', type=float, default=0.4, help='The propotion of the std of the normal distribution for capabilities(hp, strengt)')
